  ...
  <div class="home">
    ...
    <div class="right">
      ...
      <div class="right-input">
        ...
        <span>选择时间：</span>
        <a-time-picker :default-value="moment('00:00:00','HH:mm:ss')" v-model="value" />
...
export default {
  ...
  methods:{
    ...
    btnclick() {
      ...
      console.log(this.value._f);      
      console.log(this.value._d);
      console.log(typeof(this.value._d) === 'string' && this.value._d.constructor == String);
      console.log(typeof(this.value._d) === 'object' && this.value._d.constructor == Array);
      console.log(typeof(this.value._d) === 'object' && this.value._d.constructor == Object);
      // console.log(this.value._d.charAt(4)); 
      // console.log(JSON.stringify(this.value._d));
    },
    reverseItemData(){
      if(this.isgoReverse){
